...
public class QuickSort {
  ...
  { int lowToHighIndex;
    ...
    Node NlowToHighValue;
    Node NhighToLowValue;
    String parking;
    int newLowIndex;
    int newHighIndex;
    int compareResult;
    ...
    //pivotValue = ((Node)elements.elementAt(pivotIndex)).getText().toUpperCase();
    pivotValue = ((Node)elements.elementAt(pivotIndex)).getTextQuickSort().toUpperCase();
    ...
    { // loop from low to high to find a candidate for swapping      
      //lowToHighValue = ((Node)elements.elementAt(lowToHighIndex)).getText().toUpperCase();
      lowToHighValue = ((Node)elements.elementAt(lowToHighIndex)).getTextQuickSort().toUpperCase();
      
      NlowToHighValue = (Node)elements.elementAt(lowToHighIndex);
      ...
      //highToLowValue = ((Node)elements.elementAt(highToLowIndex)).getText().toUpperCase();
      highToLowValue = ((Node)elements.elementAt(highToLowIndex)).getTextQuickSort().toUpperCase();
      NhighToLowValue = (Node)elements.elementAt(highToLowIndex);
